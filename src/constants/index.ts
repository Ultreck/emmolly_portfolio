...
export const projects: Project[] = [
 {
    ...
    description: ' A social media application that allows users to sign up, post photos, like and comment on posts. Built with a responsive UI and real-time updates to replicate the core functionality of Instagram.',
    imageUrl: instaClone,
    year: "2025",
